...
public class AddMemberPanel extends javax.swing.JPanel {
     ...
     */
    public AddMemberPanel(UserModel user) {
        initComponents();
        this.member = user;

        if (!user.getDivisi().equals("BPH")) {
            divisiDropdown.removeAllItems();
            divisiDropdown.addItem(user.getDivisi());
        }

        if (user.getRole().equals("koor")) {
    ...
    private void initComponents() {
        ...
        titlePanel.setText("TAMBAH ANGGOTA");
